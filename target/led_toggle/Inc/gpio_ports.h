...
extern struct GPIOPort GPIOPortA;
extern struct GPIOPort GPIOPortB;
extern struct GPIOPort GPIOPortC;
extern struct GPIOPort GPIOPortD;

extern int activatePort(GPIOPort * port);
extern int selectPinFunction(GPIOPort * port, int pin, int function);
